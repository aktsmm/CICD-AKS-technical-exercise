...
# 2. Resource Group 作成
az group create --name rg-bbs-cicd-aks-01 --location japaneast

# 3. ACR 作成
az acr create --resource-group rg-bbs-cicd-aks-01 `
  --name acrwizexercise `
  --sku Standard
...
az aks update --resource-group rg-bbs-cicd-aks-01 `
  --name aksexercise `
