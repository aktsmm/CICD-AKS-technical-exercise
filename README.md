...
| ------------------------ | ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| `<RESOURCE_GROUP_NAME>`  | リソースグループ名           | `infra/main.bicep` (Line 4)<br>`.github/workflows/infra-deploy.yml` (Line 18)<br>`.github/workflows/app-deploy.yml` (Line 26)      | `rg-bbs-icd-aks01`                 |
...
# Line 18: リソースグループ名
env:
  RESOURCE_GROUP: rg-bbs-icd-aks01
```
...
# Line 6: リソースグループ名
variables:
  resourceGroup: "rg-bbs-icd-aks01"
```
