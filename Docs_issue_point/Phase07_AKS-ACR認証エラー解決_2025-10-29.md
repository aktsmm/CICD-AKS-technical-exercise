...
az aks show --resource-group rg-wiz-exercise01 --name aks-wiz-dev \
  --query identityProfile.kubeletidentity.objectId -o tsv

# ACR のロール割り当てを確認
az role assignment list --scope /subscriptions/<SUBSCRIPTION_ID>/resourceGroups/rg-wiz-exercise01/providers/Microsoft.ContainerRegistry/registries/acrwizdev \
...
az aks update -n aks-wiz-dev -g rg-wiz-exercise01 --attach-acr acrwizdev
